export const click = function (map, x, y) {
  const latlngPoint = new L.LatLng(x, y);
  map.fireEvent('click', {
    latlng: latlngPoint,
...
export const triggerEvent = function (eventType, selector, opts = {}) {
...
export const triggerEventSync = function (eventType, selector, opts = {}) {
...
export const waitFor = async function (timeout) {
