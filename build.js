...
(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define("build.js", ["exports"], factory) : (factory((global.lib = global.lib || {})));
  ...
  var DivIcon = L.DivIcon.extend({options: {
      className: 'ruler-icon',
      iconSize: new L.Point(10, 10)
    }});
  var Line = L.Polyline.extend({options: {
      color: '#4a4a4a',
      weight: 2,
      clickable: true
    }});
  var _cursorOffset = void 0;
  var cursorOffset = 0.3;
  var View = L.Class.extend({
    ...
    _startMeasuring: function _startMeasuring() {
      ...
      L.DomEvent.on(this._map, 'zoomend', this._zoomChanged, this).on(this._map, 'mousemove', this._mouseMove, this).on(this._map, 'click', this._mouseClick, this).on(document, 'keydown', this._onKeyDown, this);
      if (!this._layerPaint) {
